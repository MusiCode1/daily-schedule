...
| פיצ'ר | תיאור | הערה |
|-------|-------|------|
| כותרת + תיאור + לוגו | סקשן עליון ברשימה | אופציונלי - בעיקר להכנה לאירועים |
| אנשי צוות | "מי יהיה איתנו היום?" | אופציונלי - ניתן להסתיר בלחיצה |
| משימות שינוי | סימון בוטלה (🚫) / נוספה (✨) | חשוב להכנה לשינויים |
| לוח תקשורת | לחצן 💬 לפתיחת iframe | חלק קריטי מהפרויקט |
| רשימות נעולות | לתרגול/הכנה ללא חגיגות | איחוד עם מנגנון הסתרה |

### פיצ'רים להורה/צוות (ניהול)

| פיצ'ר | תיאור |
|-------|-------|
| גיבוי ענן ציבורי | הגדרות Google Cloud Console |
| העברה/שכפול לוחות | בין משתמשים |
| ניהול מאגר אנשי צוות | הוספה/עריכה/מחיקה של אנשי צוות |
| הגדרת קישור תקשורת | למשימה בעריכה |
