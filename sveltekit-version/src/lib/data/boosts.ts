...
export const BOOST_WORDS: BoostWord[] = [
	{
		...
		audioFile: { boy: 'PRAISE_ALUF_BOY', girl: 'PRAISE_ALUF_GIRL' }
	},
	{
		id: 'yeled_nehedar',
		gendered: { boy: 'אַתָּה יֶלֶד נֶהֱדָר!', girl: 'אַתְּ יַלְדָּה נֶהֱדֶרֶת!' },
		audioFile: { boy: 'NEHEDAR', girl: 'NEHEDERET' }
	},
	{
		id: 'meule',
		text: 'מְעוּלֶה!',
