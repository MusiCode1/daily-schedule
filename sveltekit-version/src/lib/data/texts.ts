...
const TEXTS_ADMIN = {
	...
	BACKUP_TAB: 'גיבוי',
	KIOSK_TAB: 'קיוסק',
	KIOSK_QR_TITLE: 'QR לחיבור מהיר',
	KIOSK_QR_SUBTITLE: 'סרוק עם הטלפון כדי להתחבר לממשק ניהול הקיוסק',
	KIOSK_QR_NOT_AVAILABLE: 'פיצ\'ר זה זמין רק בסביבת Fully Kiosk Browser',
	KIOSK_QR_LOADING: 'טוען פרטי התקן...',
	KIOSK_QR_ERROR: 'שגיאה בטעינת פרטי הקיוסק',
	KIOSK_QR_REFRESH: 'רענן',
